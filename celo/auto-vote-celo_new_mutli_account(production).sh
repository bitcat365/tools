...
do
        ...
        account_validator_dollarBalance2=`celocli account:balance $account_validator_addr2 | grep dollarBalance | awk -F 'dollarBalance: ' '{print $2}'`
        ...
        account_validator_goldBalance_vote2=`echo $account_validator_goldBalance2 - $account_goldBalance_hold | bc`
